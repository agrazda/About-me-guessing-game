...
// let knowMeOrig = prompt('Do you think you know me?').toLowerCase();
// console.log(knowMeOrig);

//console.log(knowMe);
let score = 0;

function knowMeFunc(question, responseYes, responseNo, responseDefault) {
...
const responsesYes = [
  ...
  'I did for most my life. I live in Oregon now',
  'I sure do. Cats! #\catdad',
];
const responsesNo = [
  'That is too bad! Take a crack at it!',
  'Your right! I live in Oregon!',
  'Oh so close! I have cats! #\lintrollerseverywhere',
];
const responsesDefault = [
  'I didn\'t get that, but you will know me soon enough!',
  'I didn\'t get that, but I live in Oregon!',
  'I didn\'t get that, but I have cats!',
];

for (let i = 0; i < questions.length; i++ ) {
  knowMeFunc(questions[i], responsesYes[i], responsesNo[i], responsesDefault[i]);
}
